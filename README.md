...
- 浏览自选股、ETF、全球指数、K 线和打新日历；基金中心支持独立的自选基金列表，交易所上市 ETF 还可直接加入现有行情展示分组；主力资金历史数据统一采用东方财富口径。
- 支持账号密码注册/登录、微信开放平台扫码登录及安全会话。
- 登录后按账号同步自选股、自选基金、分组、主题、指标等页面配置；主题提供云白、暖纸、石墨、深海、松林、暮紫及跟随系统。
...
- 账号首次登录会询问是否关联当前页面配置。选择“关联当前配置”后，自选股、自选基金、分组、主题、指标、行情颜色、刷新频率、当前页面和异动记录会保存到该账号。
